...
namespace Microsoft.Samples.Kinect.BodyBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        Semaphore avaliable_sound_device = new Semaphore(1, 1);
        /// <summary>
        ...
        private SoundPlayer soundPlayer_1 = new SoundPlayer("C:\\sound\\dongdong2.wav");
        private SoundPlayer soundPlayer_2 = new SoundPlayer("C:\\sound\\ci2.wav");
        ...
        public bool Play_Sound_DongDongCi()
        {
            if (avaliable_sound_device.WaitOne(0))
            {
    ...
    {
        public LinkedList<Point> leftHand = new LinkedList<Point>();
        public LinkedList<Point> rightHand = new LinkedList<Point>();
        ...
        public bool is_applauding()
        {
            if (leftHand.Count < 5 || rightHand.Count < 5)
            {
                Console.WriteLine("linked list not full");
                return false;
            }
            LinkedListNode<Point> nodel=leftHand.First;
            LinkedListNode<Point> noder=rightHand.First;
            Point pl = leftHand.First.Value;
            Point pr = rightHand.First.Value;
            double distance = pr.X - pl.X;
            
            while (nodel.Next != null && noder.Next != null)
            {
                double new_distance=noder.Next.Value.X-nodel.Next.Value.X;
                if (distance +10> new_distance)
                {
                    //Console.WriteLine("distance not decreasing!");
                    return false;
                }
